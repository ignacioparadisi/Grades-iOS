...
class TermDetailViewController2: BaseViewController {
...
extension TermDetailViewController2: UITableViewDelegate, UITableViewDataSource {
...
extension TermDetailViewController2: CreateSubjectViewControllerDelegate {
    func shouldRefresh() {
        fetchSubjects()
